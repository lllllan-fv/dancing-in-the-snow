                ...
                $.ajax({
                    ...
                    success: function(article) {
                        ...
                        if (idx & 1) {
                            ...
                            str += article["article_title"] + "</h2>";
                            str += article["article_text"].substring(0, Math.min(100, article["article_text"].length)) + "...";
                            str += "</div></div></div>";
                        } else {
                            ...
                            <div class='preview-col preview-img col-sm-4 col-xs-12 wow animate__animated animate__fadeInRight' data-wow-delay='0.5s'>\
                                ...
                                <a><div class='preview-info'><h3>Author: <strong>"
                            str += article["author_name"];
